...
describe "multiply" do
  it "multiplies two numbers test #1" do
		expect(multiply(2,3)).to eq(6)
	end

  it "multiplies two numbers test #2" do
		expect(multiply(5,10)).to eq(50)
	end

  it "multiplies two numbers test #3" do
		expect(multiply(5,0)).to eq(0)
	end

  it "multiplies several numbers test #1" do
		expect(multiply(2,2,2)).to eq(8)
	end

  it "multiplies several numbers test #2" do
		expect(multiply(2,2,0)).to eq(0)
	end

  it "multiplies several numbers test #3" do
		expect(multiply(10,10,5)).to eq(500)
	end
end
